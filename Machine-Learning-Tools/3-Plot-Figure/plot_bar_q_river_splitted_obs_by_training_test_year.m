function plot_bar_q_river_splitted_obs_by_training_test_year(dataset)
    ...
    % test 2018-2019 Q_River_LOW
    result(4,1) = height(dataset((dataset.Year == 2018 | dataset.Year == 2019) ...
        & strcmp(string(dataset.QriverClass), "LOW"),:));
    % test 2018-2019 Q_River_STRONG
    result(4,2) = height(dataset((dataset.Year == 2018 | dataset.Year == 2019) ...
        & strcmp(string(dataset.QriverClass), "STRONG"),:));
    ...
    ylabel('Observations');
    xticks([1,2,3,4]);
    xticklabels({'Training 2016-2017', 'Test 2018', 'Test 2019', 'Test 2018-2019'});
    title('Number of observations by training/test for Qriver class');
