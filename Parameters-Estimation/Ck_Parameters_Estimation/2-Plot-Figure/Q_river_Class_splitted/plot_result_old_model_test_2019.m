...
%% Test dataset
test_table_results = array2table([ck_dataset.CkObs((ck_dataset.Year == 2019) & strcmp(string(ck_dataset.QriverClass), q_river_selected_class))...
    ck_dataset.CkOldmodel((ck_dataset.Year == 2019) & strcmp(string(ck_dataset.QriverClass), q_river_selected_class))...
