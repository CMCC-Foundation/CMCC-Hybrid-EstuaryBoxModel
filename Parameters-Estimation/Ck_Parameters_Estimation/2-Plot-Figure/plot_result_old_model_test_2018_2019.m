...
load("..\1-Trained-Models\training_2016_2017_test_2018_2019_comparing_old_model\Ck-Trained-Tested-model-k-5-old-configuration.mat");

algorithm_names = {'old model','random forest', 'lsboost', 'neural network'};
response = 'CK_Obs';

%% Test dataset
test_table_results = array2table([ck_dataset.CK_Obs(ck_dataset.Year == 2018 | ck_dataset.Year == 2019 )...
    ck_dataset.Ck_old_model(ck_dataset.Year == 2018 | ck_dataset.Year == 2019)...
...
compare_real_pred_obs(test_table_results, algorithm_names, "Test dataset 2018 - 2019", "ck");
