...
save('0-Dataset/training_test_2016_2019/Ck-Training-Dataset.mat', ...
    'ck_training_dataset');
save('0-Dataset/training_test_2016_2019/Ck-Test-Dataset.mat', ...
    'ck_test_dataset');
...
result_trained_model.random_forest.test_results.test_predictions = result_trained_model.random_forest.model.predictFcn(removevars(ck_test_dataset, {'Year', 'Ck_old_model'}));
...
result_trained_model.lsboost.test_results.test_predictions = result_trained_model.lsboost.model.predictFcn(removevars(ck_test_dataset, {'Year','Ck_old_model'}));
...
result_trained_model.neural_network.test_results.test_predictions = result_trained_model.neural_network.model.predictFcn(removevars(ck_test_dataset, {'Year', 'Ck_old_model'}));
...
clc;
close all;
writetable(results_training, '1-Trained-Models/training_test_2016_2019/Results-ck-calibration-model-k-10.xlsx', 'WriteRowNames',true);
writetable(results_test, '1-Trained-Models/training_test_2016_2019/Results-ck-test-model-k-10.xlsx', 'WriteRowNames',true);
save("1-Trained-Models\training_test_2016_2019\Ck-Trained-Tested-model-k-10.mat","result_trained_model");