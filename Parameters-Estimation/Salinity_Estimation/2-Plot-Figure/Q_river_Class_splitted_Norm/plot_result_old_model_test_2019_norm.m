...
%% Test dataset
test_table_results = array2table([salinity_dataset.SalinityObs((salinity_dataset.Year == 2019) & strcmp(string(salinity_dataset.QriverClass), q_river_selected_class))...
    salinity_dataset.SalinityOldmodel((salinity_dataset.Year == 2019) & strcmp(string(salinity_dataset.QriverClass), q_river_selected_class))...
