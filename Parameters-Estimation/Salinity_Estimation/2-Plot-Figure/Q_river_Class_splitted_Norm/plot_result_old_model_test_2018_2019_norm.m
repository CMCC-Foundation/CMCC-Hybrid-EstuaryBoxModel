...
load('..\..\0-Dataset\training_2016_2017_test_2018_2019_comparing_old_model\Q_river_Class_splitted_Norm\SALINITY_Q_RIVER_CLASS_SPLIT_NORM.mat');
load(strcat("..\..\1-Trained-Models\training_2016_2017_test_2018_2019_comparing_old_model\Q_river_Class_splitted_Norm\",q_river_selected_class,'\Salinity-Trained-Tested-model-norm.mat'));

algorithm_names = {'old model','random forest', 'lsboost', 'neural network'};
response = 'SalinityObs';

%% Test dataset
test_table_results = array2table([salinity_dataset.SalinityObs((salinity_dataset.Year == 2018 | salinity_dataset.Year == 2019) & strcmp(string(salinity_dataset.QriverClass), q_river_selected_class))...
    salinity_dataset.SalinityOldmodel((salinity_dataset.Year == 2018 | salinity_dataset.Year == 2019) & strcmp(string(salinity_dataset.QriverClass), q_river_selected_class))...
...
create_perfect_fit_residuals_plot(test_table_results, algorithm_names, response, strcat("Test 2018-2019 with ",q_river_selected_class, " Qriver"),false,0);