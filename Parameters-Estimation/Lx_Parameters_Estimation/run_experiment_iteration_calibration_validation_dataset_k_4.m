...
writetable(results_training_rf,'1-Trained-Models/Iteration-Results/training_rf.xlsx');
writetable(results_training_lsb,'1-Trained-Models/Iteration-Results/training_lsb.xlsx');
writetable(results_test_rf,'1-Trained-Models/Iteration-Results/test_rf.xlsx');
writetable(results_test_lsb,'1-Trained-Models/Iteration-Results/test_lsb.xlsx');
