function [results] = random_forest(trainingDataset,targetFeatureName,max_objective_evaluations, k)
%RANDOM_FOREST Function to train a random forest regression model
%   Input:
%   1) trainingDataset: 
