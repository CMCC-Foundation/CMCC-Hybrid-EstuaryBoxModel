...
% lenght of salinity intrusion (Lx). The aim is to develop two machine 
...
component_1_trained_models.RF = random_forest(...
    lx_training_dataset(:,["Qll","Qriver","Qtidef","Sll","LxObs"]), ...
...
component_1_trained_models.RF.test_results.test_predictions = ...
    component_1_trained_models.RF.model.predictFcn(lx_test_dataset(:,["Qll","Qriver","Qtidef","Sll"]));
...
component_1_trained_models.LSBoost.test_results.test_predictions = ...
    component_1_trained_models.LSBoost.model.predictFcn(lx_test_dataset(:,["Qll","Qriver","Qtidef","Sll"]));
