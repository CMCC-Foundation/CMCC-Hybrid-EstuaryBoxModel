...
% Component-4 of Hybrid-EBM. This component is the final part of Hybrid-EBM 
% and it is used to predict the Sul values, by using the Component-1 and 
% Component-2 (ML models) and Component-3 (Qul equation). 

%% Add path and directory
addpath(genpath("..\..\lib\utility\"));
addpath(genpath("..\..\lib\printer\"));
addpath(genpath("..\..\..\models\Component-1-Lx"));
addpath(genpath("..\..\..\models\Component-2-Ck"));
addpath(genpath("..\..\..\models\Component-4-Sul"));
addpath(genpath("..\..\..\data\raw\Component-4-Sul\"));
addpath(genpath("..\Component-3-Qul\"))

%% Read dataset
features_dataset = import_dataset("Input-Features-For-Sul.xlsx", 12, "A2:L1462", "Sheet1", ...
