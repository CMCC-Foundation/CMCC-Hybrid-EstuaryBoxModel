...
writetable(results_training, '3-Trained-Models/Results-calibration-model-k-4.xlsx', 'WriteRowNames',true);
writetable(results_test, '3-Trained-Models/Results-test-model-k-4.xlsx', 'WriteRowNames',true);
save("3-Trained-Models\Trained-Tested-model-k-4.mat","result_trained_model");
